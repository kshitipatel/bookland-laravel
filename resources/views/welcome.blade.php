        ...
        <div class="container">
                <div class="header-content-wrapper">
                    <div class="logo">
                        <div class="logo-text">
                            <a href="/">
                            <div class="logo-title">BOOKLAND</div>
                        </a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('app/img/slider-photo1.jpg')}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('app/img/slider-photo1.jpg')}}" class="link-image js-zoom-image">
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('app/img/slider-photo5.jpg')}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('app/img/slider-photo5.jpg')}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                        </div>
            ...
            <div class="contacts">
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">Made by</a>
                            <p class="sub-title">Kshiti Patel</p>
                            <p class="sub-title">Nidhi Patel</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            <a href="#" class="title">CHARUSAT UNIVERSITY</a>
                            <p class="sub-title">changa, Anand</p>
                        </div>
                    </div>
                </div>
            </div>
